...
2. 使用 R 语言操作地理矢量数据、使用 Stata 绘制精美地图：https://rstata.duanshu.com/#/brief/course/c51384ae56994495b223b366c7449377
...
这份地图数据的坐标参考系是 `+proj=eck3 +lat_0=0 +lon_0=150 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs`，似乎 geo2xy 命令不支持把经纬度转换成这个坐标系，所以我编写了一个 网页应用来帮助转换：https://czxb.shinyapps.io/crs-trans/
